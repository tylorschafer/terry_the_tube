...
VOICE_INSTRUCTIONS = {
    ...
    "passive_aggressive_librarian": {
        ...
        "instruction": "Speak like a frustrated librarian - artificially sweet tone masking irritation, exaggerated politeness that sounds fake, gritted teeth politeness. Over-enunciate when being passive-aggressive, use dramatic pauses, stress polite words sarcastically. Sound like customer service on the verge of breakdown."
    },
